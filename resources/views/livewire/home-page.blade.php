<div>
    ...
    <section class="relative bg-gradient-to-t from-teal-600 to-teal-800 text-white min-h-[70vh] flex items-center">
        ...
        <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <div class="flex justify-center space-x-4">
                <a href="#layanan"
                    class="bg-white text-teal-700 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-gray-100 transform hover:-translate-y-1 transition-all duration-300">
                    Lihat Layanan Kami
                </a>
                <a href="#kontak"
                    class="bg-yellow-400 text-gray-900 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-yellow-300 transform hover:-translate-y-1 transition-all duration-300">
                    Hubungi Kami
                </a>
            </div>
        </div>
    ...
    <section class="bg-gray-50 mt-16 relative z-20 pb-16">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-teal-500 text-center transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div
                        class="font-semibold px-4 py-2 rounded-full text-sm {{ $statusOperasional == 'Buka' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <div
                    class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-yellow-500 text-center transform hover:scale-105 transition-transform duration-300">
                    <div class="flex justify-center mb-4">
                    ...
                    <a href="{{ route('CaraBerobat') }}" class="font-semibold text-teal-600 hover:text-teal-800">Lihat
                        Alur &rarr;</a>
                </div>

                {{-- Card 3: Lokasi --}}
                <div
                    class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-blue-500 text-center transform hover:scale-105 transition-transform duration-300">
                    <div class="flex justify-center mb-4">
                    ...
                    <a href="https://maps.app.goo.gl/rCmK3FxtT6u5aVRFA"
                        class="font-semibold text-teal-600 hover:text-teal-800">Lihat Peta &rarr;</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="layanan" class="py-20">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto mb-12">Dari pemeriksaan rutin hingga penanganan khusus, kami
                menyediakan layanan komprehensif.</p>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600 text-sm">Perawatan kesehatan gigi dan mulut, mulai dari penambalan hingga
                        pembersihan karang gigi.</p>
                </div>
                {{-- Layanan Item 3 --}}
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h4 class="font-bold text-lg mb-2">Kesehatan Ibu & Anak</h4>
                    <p class="text-gray-600 text-sm">Layanan komprehensif untuk ibu hamil, persalinan, dan tumbuh
                        kembang anak.</p>
                </div>
                {{-- Layanan Item 4 --}}
                <div class="bg-white rounded-lg shadow-md p-6">
